...
int main( void ) {
     ...
     *     - processamentos adicionais.
     ----------------------------------------------------*/
        ...
        int vertice1 = (inicioX + finalX) / 2;
        int vertice2 = inicioY - altura;
    ...
    while ( !WindowShouldClose() ) {
        ...
        DrawLine(inicioX,inicioY,finalX,finalY, RED);
        DrawLine(inicioX,inicioY,vertice1,vertice2, RED);
        DrawLine(finalX,finalY,vertice1,vertice2, RED);
